...
> **Tip**: When in doubt, start with `warn` severity. You can always escalate to `error` if violations persist, but overly strict validators frustrate developers and get disabled.
